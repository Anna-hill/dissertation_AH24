...
G:\LAStools\bin\lasground_new.exe -i Z:\s2559258\dissertation_AH24\data\test\sim_cleaned\*.las -odir Z:\s2559258\dissertation_AH24\data\test\sim_ground500505 -step 50 -offset 0.5 -spike 0.5  -cores 3
G:\LAStools\bin\lasground_new.exe -i Z:\s2559258\dissertation_AH24\data\test\sim_cleaned\*.las -odir Z:\s2559258\dissertation_AH24\data\test\sim_ground600505 -step 60 -offset 0.5 -spike 0.5  -cores 3
