G:\LAStools\bin\txt2las.exe -i P:\dissertation\dissertation_AH24\data\oak_ridge\pts_metric\*.pts -odir P:\dissertation\dissertation_AH24\data\oak_ridge\sim_las -utm 16N
